<template>
  <div class="container">
    <h1 class="my-4 fw-bold text-center">Lista de opiniones</h1>
      ...
      <div class="accordion accordion-flush " id="accordionFlushExample">
        <div class="accordion-item" v-for="(opinion, index) in opiniones" :key="index">
          <h2 class="accordion-header" :id="`flush-${index}`">
            ...
            aria-expanded="false" aria-controls="flush-collapseOne"> Opinión creada por: {{ opinion.nombre }}. Para el juego: {{ opinion.juego }}
            </button>
          </h2>
