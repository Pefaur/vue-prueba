<template>
  <div class="container mt-4">
    <h1 class="text-center my-4 fw-bold">Lista de juegos disponibles</h1>
    <div class="row">
      <div v-for="(juego, index) in juegos" :key="index" class="col-lg-4 col-sm-6 card-group">
      <div class="card">
      ...
      <div class="card-body button">
        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modal-opinion" @click="cargarJuego(juego.name)">Opinar</button>
      </div>
      </div>
    </div>
